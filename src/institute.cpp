...
/**
 * @brief Overload == operator for Institute.
 * @param institute Another institute object.
 * @return True if this institute's name is equal to the other's.
 */
bool Institute::operator==(const Institute& other) const 
{
 ...
 * @brief Overload != operator for Institute.
 * @param institute Another institute object.
 * @return True if this institute's name is not equal to the other's.
 */
bool Institute::operator!=(const Institute& other) const 
{
    return name != other.name;
