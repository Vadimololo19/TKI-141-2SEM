...
/**
 * @brief Overload == operator for comparing specialities by name.
 * @param speciality Another speciality object.
 * @return True if this speciality's name is equal to the other's.
 */
bool Speciality::operator==(const Speciality& speciality) const 
{
    return name == speciality.name;
 ...
 * @brief Overload != operator for comparing specialities by name.
 * @param speciality Another speciality object.
 * @return True if this speciality's name is not equal to the other's.
 */
bool Speciality::operator!=(const Speciality& speciality) const 
{
    return name != speciality.name;
