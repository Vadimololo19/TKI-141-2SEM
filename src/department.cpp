...
/**
 * @brief Overload == operator for comparing departments by name.
 * @param department Another department object.
 * @return True if this department's name is equal to the other's.
 */
bool Department::operator==(const Department& department) const 
{
    return name == department.name;
 ...
 * @brief Overload != operator for comparing departments by name.
 * @param department Another department object.
 * @return True if this department's name is not equal to the other's.
 */
bool Department::operator!=(const Department& department) const 
{
    return name != department.name;
