...
/**
 * @brief Overload == operator for comparing groups by name.
 * @param group Another group object.
 * @return True if this group's name is equal to the other's.
 */
bool Group::operator==(const Group& group) const 
{
    return name == group.name;
 ...
 * @brief Overload != operator for comparing groups by name.
 * @param group Another group object.
 * @return True if this group's name is not equal to the other's.
 */
bool Group::operator!=(const Group& group) const 
{
    return name != group.name;
