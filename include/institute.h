...
public:
    ...
    /**
     * @brief Default constructor for Institute.
     */
    Institute() {};
     ...
     * @param other Institute object to compare with.
     * @return True if the Institute objects are equal, false otherwise.
     */
     ...
     * @brief Function to overload != operator.
     * @param other Institute object to compare with.
     * @return True if the Institute objects are not equal, false otherwise.
     */
    bool operator!=(const Institute& other) const;
};
